...
import at.fhtw.swen2.presentation.events.ApplicationErrorEvent;
...
public class StageManager {
    ...
    public void onStartupEvent(ApplicationStartupEvent event) {
        ...
        try {
            Parent parent = (Parent) viewManager.load("at/fhtw/swen2/presentation/view/Application.fxml", stage);
